...
This project provides a Docker container for [VLC](https://www.videolan.org).
...
[Releases]: https://github.com/jlesage/docker-vlc/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/vlc/tags
...
container, it would proxy all HTTP requests for `vlc.domain.tld` to
...
server {
	...
	location = /vlc {return 301 $scheme://$http_host/vlc/;}
	location /vlc/ {
		proxy_pass http://docker-vlc/;
...
| **Application version** label | Displays the version of VLC integrated into Docker image. |
...
Any desktop notification generated by VLC is forwarded to the
...
second, etc). To allow VLC to access the first drive, use
this parameter:
